#!/usr/bin/env bash
# Launch PPM N-gram Rescore submission
...
export NGRAM_MODE="${NGRAM_MODE:-two_pass}"
export NGRAM_EVAL_CHUNK_TOKENS="${NGRAM_EVAL_CHUNK_TOKENS:-262144}"
...
echo "NGRAM: orders=${NGRAM_MIN_ORDER}-${NGRAM_MAX_ORDER} buckets=${NGRAM_NUM_BUCKETS} alpha=[${NGRAM_ALPHA_MIN},${NGRAM_ALPHA_MAX}]"
