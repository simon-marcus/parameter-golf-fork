#!/usr/bin/env bash
# Launch fast-eval online phrase-cache record candidate
...
export NGRAM_ONLINE_CHUNK_TOKENS="${NGRAM_ONLINE_CHUNK_TOKENS:-65536}"
export NGRAM_TEMPERATURE="${NGRAM_TEMPERATURE:-0.85}"
export NGRAM_CALIBRATION_ENABLED="${NGRAM_CALIBRATION_ENABLED:-1}"
export NGRAM_CALIBRATION_MIN_TOKENS="${NGRAM_CALIBRATION_MIN_TOKENS:-65536}"
export NGRAM_CALIBRATION_MAX_TOKENS="${NGRAM_CALIBRATION_MAX_TOKENS:-131072}"
...
case "$MODE" in
    smoke)
        ...
        export NGRAM_ONLINE_CHUNK_TOKENS="${NGRAM_ONLINE_CHUNK_TOKENS:-16384}"
...
echo "CALIB: enabled=${NGRAM_CALIBRATION_ENABLED} tokens=[${NGRAM_CALIBRATION_MIN_TOKENS},${NGRAM_CALIBRATION_MAX_TOKENS}] alpha_grid=${NGRAM_CALIBRATION_ALPHA_MAX_GRID} center_grid=${NGRAM_CALIBRATION_ENTROPY_CENTER_GRID}"
