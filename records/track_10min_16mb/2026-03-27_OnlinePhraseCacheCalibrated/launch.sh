#!/usr/bin/env bash
# Launch calibrated online phrase-cache record candidate
...
export NGRAM_CALIBRATION_MIN_TOKENS="${NGRAM_CALIBRATION_MIN_TOKENS:-131072}"
export NGRAM_CALIBRATION_MAX_TOKENS="${NGRAM_CALIBRATION_MAX_TOKENS:-524288}"
