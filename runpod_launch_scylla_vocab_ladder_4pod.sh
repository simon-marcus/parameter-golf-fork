...
SUITE_ROOT_REMOTE="${SUITE_ROOT_REMOTE:-$REMOTE_ROOT/records/scylla_2_claude/frontier_runs_vocab_ladder}"
...
VOCABS=(1536 2048 3072 4096)
CASES=(ladder_1536 ladder_2048 ladder_3072 ladder_4096)
TRAIN_SHARDS=(12 11 10 9)
VAL_SHARDS=(1 1 1 1)
POD_NAMES=(
  "pg-scylla-v1536"
  "pg-scylla-v2048"
...
main() {
  ...
  echo "Launched 4 Scylla ladder pods."
