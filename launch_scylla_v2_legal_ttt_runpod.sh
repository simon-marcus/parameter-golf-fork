...
SCRIPT_PATH="/workspace/parameter-golf/train_gpt_legal_ttt.py"
RECORD_ROOT="/workspace/parameter-golf/records/track_10min_16mb/2026-03-31_scylla_v2_legal_ttt_runpod"
...
if [[ ! -f "$SCRIPT_PATH" ]]; then
  echo "missing train script: $SCRIPT_PATH"
  exit 1
fi
...
export RUN_ID="${RUN_ID:-scylla_v2_legal_ttt_runpod}"
