...
RECORD_ROOT="${RECORD_ROOT:-/workspace/parameter-golf/records/track_10min_16mb/2026-03-30_JEPAIsolationRunpod}"
...
export TARGET_ENCODER_MODE="${TARGET_ENCODER_MODE:-patch_trainable}"
export TARGET_ENCODER_EMA="${TARGET_ENCODER_EMA:-${TARGET_EMA:-0.995}}"
...

{
  ...
  echo "TARGET_ENCODER_MODE=$TARGET_ENCODER_MODE"
  echo "TARGET_ENCODER_EMA=$TARGET_ENCODER_EMA"
